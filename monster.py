...
def MailmanNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.yellow),
        'Combat': Combat(),
...
def ItemWorldClerkNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.magenta),
        'Combat': Combat(),
...
def UptierShopNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.light_gray),
        'Combat': Combat(),
...
def ModShopNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.green),
        'Combat': Combat(),
...
def EquipmentShopNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.blue),
        'Combat': Combat(),
...
def SkillShopNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.lighter_blue),
        'Combat': Combat(),
...
def ItemEnhancerNPC(position):
    ...
    return Entity(str(uuid.uuid4()), components={
        ...
        'Neutral': Combat(),
        'Position': Position(x, y),
        'Render': Render(character=2, colour=tcod.peach),
        'Combat': Combat(),
